...
<div class="header">
  ...
  <div class="header-buttons">
    <button class="header-btn" on:click={() => $showHowToPlay = true} {disabled} >
      <svg
    ...
    <button class="header-btn" on:click={() => $showStatistics = true} {disabled}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="header-btn-icon"
        height="28"
    ...
    <button class="header-btn" on:click={() => $showSettings = true} {disabled}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="header-btn-icon"
        height="28"
